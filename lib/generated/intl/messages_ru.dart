...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allowChanges": MessageLookupByLibrary.simpleMessage(
          "Разрешить изменения?",
        ),
        ...
        "currentWorkout": MessageLookupByLibrary.simpleMessage(
          "Текущая тренировка",
        ),
        ...
        "hintWorkoutProcess": MessageLookupByLibrary.simpleMessage(
          "Это ваша текущая программа тренировок. Нажмите на день в списке, чтобы начать тренировку. Нажмите кнопку +, чтобы добавить день, нажмите кнопку 📁, чтобы просмотреть список программ и выбрать программу по умолчанию. Проведите вправо для редактирования и удаления дня.",
        ),
        ...
        "oneBarOrNoBar": MessageLookupByLibrary.simpleMessage(
          "Один гриф или нет грифа",
        ),
        "pageAddEx":
        ...
        "selectProgram": MessageLookupByLibrary.simpleMessage(
          "Cоздайте или выберите программу",
        ),
        ...
        "workoutFinished": MessageLookupByLibrary.simpleMessage(
