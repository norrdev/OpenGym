                  ...
                  return Row(
                    ...
                    children: [
                      ...
                      StepsIndicator(
                        ...
                        nbSteps: maxSet + 1,
                        selectedStepColorIn: Theme.of(context).indicatorColor,
                        selectedStepColorOut: Theme.of(context).indicatorColor,
                        unselectedStepColorIn: Theme.of(context).dividerColor,
                        unselectedStepColorOut: Theme.of(context).dividerColor,
                        doneStepColor: Theme.of(context).dividerColor,
                        doneLineColor: Theme.of(context).dividerColor,
                        undoneLineColor: Theme.of(context).dividerColor,
                      ),
                      IconButton(
